...
public final class NyxConfig {
    ...
    static {
        ...
        ALLOWED_DIMENSIONS = b.defineList("allowedDimensions",
                List.of("minecraft:overworld", "twilightforest:twilight_forest"),
        ...
        MOB_DUPLICATION_BLACKLIST = b.defineList("mobDuplicationBlacklist",
                List.of("minecraft:zombie", "minecraft:skeleton", "minecraft:enderman",
                        "minecraft:creeper", "minecraft:spider", "minecraft:cave_spider",
                        "minecraft:zombified_piglin"),
                o -> o instanceof String);
        IS_MOB_DUPLICATION_WHITELIST = b.define("isMobDuplicationWhitelist", true);
        ...
        ADD_POTION_EFFECTS = b.define("addPotionEffects", false);
        ADDITIONAL_MOBS_CHANCE = b.defineInRange("additionalMobsChance", 10, 0, 1000);
        b.pop();

        b.push("enchantments");
        ENCHANTMENTS = b.define("enchantments", false);
        LUNAR_EDGE_XP = b.define("lunarEdgeXp", true);
        DISALLOW_DAY_ENCHANTING = b.define("disallowDayEnchanting", false);
        ...
        b.push("harvestMoon");
        HARVEST_MOON_ON_FULL = b.define("harvestMoonOnFull", false);
        HARVEST_MOON_GROW_AMOUNT = b.defineInRange("harvestMoonGrowAmount", 10, 0, 100);
        HARVEST_MOON_GROW_INTERVAL = b.defineInRange("harvestMoonGrowInterval", 100, 1, 1000);
        HARVEST_MOON_CHANCE = b.defineInRange("harvestMoonChance", 0.04, 0.0, 1.0);
        ...
        STAR_SHOWER_CHANCE = b.defineInRange("starShowersChance", 0.065, 0.0, 1.0);
        ...
        STAR_SHOWER_GRACE = b.defineInRange("starShowersGracePeriod", 4, 0, 1000);
        b.pop();
        ...
        BLOOD_MOON_SPAWN_RADIUS = b.defineInRange("bloodMoonSpawnRadius", 12, 0, 128);
        BLOOD_MOON_ON_FULL = b.define("bloodMoonOnFull", false);
        BLOOD_MOON_CHANCE = b.defineInRange("bloodMoonChance", 0.05, 0.0, 1.0);
        BLOOD_MOON_START_NIGHT = b.defineInRange("bloodMoonStartNight", 4, 0, 1000);
        BLOOD_MOON_INTERVAL = b.defineInRange("bloodMoonInterval", 0, 0, 1000);
        BLOOD_MOON_GRACE = b.defineInRange("bloodMoonGracePeriod", 4, 0, 1000);
        b.pop();
        ...
        CRYSTAL_DURABILITY = b.defineInRange("crystalDurability", 150, 1, 1000000);
        HAMMER_DAMAGE = b.defineInRange("hammerDamage", 8, 1, 1000);
        b.pop();
