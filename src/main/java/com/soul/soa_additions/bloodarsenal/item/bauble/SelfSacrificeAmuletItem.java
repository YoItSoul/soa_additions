...
/**
 * Self-Sacrifice Amulet — stores LP from damage the wearer receives.
...
public class SelfSacrificeAmuletItem extends Item implements ICurio {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(Component.translatable("tooltip.soa_additions.self_sacrifice_amulet.lp", lp, MAX_LP)
