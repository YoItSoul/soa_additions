    ...
    public static final RegistryObject<CreativeModeTab> GC_TAB = CREATIVE_MODE_TABS.register("gc_items_tab",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(com.soul.soa_additions.nyx.NyxItems.METEOR_INGOT.get());
                        ...
                        output.accept(TConEvoItems.ESSENCE_METAL_INGOT.get());
                        output.accept(TConEvoItems.ENERGETIC_METAL_INGOT.get());
                        output.accept(TConEvoItems.PRIMAL_METAL_INGOT.get());
                        output.accept(TConEvoItems.UNIVERSAL_METAL_INGOT.get());
                        output.accept(TConEvoItems.BOUND_METAL_INGOT.get());
                        output.accept(TConEvoItems.CHAOTIC_INGOT.get());
                        output.accept(TConEvoItems.DRACONIC_METAL_INGOT.get());
                        output.accept(TConEvoItems.SENTIENT_METAL_INGOT.get());
                        output.accept(ModItems.URU_INGOT.get());
                        output.accept(TConEvoItems.WYVERN_INGOT.get());
