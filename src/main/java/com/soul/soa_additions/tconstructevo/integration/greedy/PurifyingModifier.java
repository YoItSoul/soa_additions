...
public class PurifyingModifier extends Modifier implements InventoryTickModifierHook {
    @Override
    ...
    public void onInventoryTick(IToolStackView tool, ModifierEntry mod, Level level, LivingEntity holder,
        ...
        if (holder.hasEffect(MobEffects.WITHER)) holder.removeEffect(MobEffects.WITHER);
    }
}
