...
/** TAIGA "garishly": 50% chance clear block drops. Mob-drop bonus handled in event bus. */
public class GarishlyModifier extends Modifier implements ProcessLootModifierHook {
    ...
    public void processLoot(IToolStackView tool, ModifierEntry modifier, List<ItemStack> drops, LootContext ctx) {
        if (rng.nextBoolean()) drops.clear();
    }
}
